...
public class CodeTableMetaResource implements CodeTableMetaService {
    ...
    @Override
    public void update(BigInteger id, CodeTableMetaCommand command) {
        var codeTableMeta = codeTableMetaMapper.convert(command);
        codeTableMeta.setId(id);
        validateModifyingResult(codeTableMetaRepository.update(codeTableMeta));
    }
