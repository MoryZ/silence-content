...
public class LiveRoomQuery {
    ...
    @RelationalQueryProperty(name = "startTime", type = Part.Type.GREATER_THAN_EQUAL)
    private Instant startTimeStart;

    @RelationalQueryProperty(name = "startTime", type = Part.Type.LESS_THAN_EQUAL)
    private Instant startTimeEnd;
    @RelationalQueryProperty(name = "endTime", type = Part.Type.GREATER_THAN_EQUAL)
    private Instant endTimeStart;

    @RelationalQueryProperty(name = "endTime", type = Part.Type.LESS_THAN_EQUAL)
