...
public class TournamentConfigCacheDto {
    ...
    // 活动信息
    TournamentMarketingEventCacheDto event;

    // 赛事奖励
    List<TournamentRewardItemCacheDto> tournamentRewards;
    ...
    public TournamentMarketingEventCacheDto getEvent() {
        return event;
    }

    public void setEvent(TournamentMarketingEventCacheDto event) {
        this.event = event;
    }

    public List<TournamentRewardItemCacheDto> getTournamentRewards() {
        return tournamentRewards;
    }

    public void setTournamentRewards(List<TournamentRewardItemCacheDto> tournamentRewards) {
